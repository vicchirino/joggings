...
//  joggin
//
//  Created by Victor Gabriel Chirino on 3/10/15.
...
class ResultsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.registerNib(UINib(nibName:"HomeTableViewCell", bundle: nil), forCellReuseIdentifier: "FiltredCell")
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCellWithIdentifier("FiltredCell") as? HomeTableViewCell
        if cell == nil {
            cell = HomeTableViewCell(style: UITableViewCellStyle.Default, reuseIdentifier: "FiltredCell")
        }
